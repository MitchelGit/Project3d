...
namespace UnityStandardAssets.Characters.FirstPerson
{
...

    {
        ...
        {
            if (eventData.pointerCurrentRaycast.gameObject.GetComponent<ItemButton>()._Myobject)
            {
                Player.Instance.SelectingItem(eventData.pointerCurrentRaycast.gameObject.GetComponent<ItemButton>()._Myobject);
            }
